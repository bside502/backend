...
public interface PersonaMapper {
	...
	//선호 감정
	@Select("SELECT emotion_select as preferEmotion, count(*) as count "
			+ "FROM persona GROUP BY emotion_select order by count desc LIMIT 1")
	public Map<String, Object> preferEmotion();
